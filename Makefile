#############################################################################
# Makefile for building: Blackjack.app/Contents/MacOS/Blackjack
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  Blackjack.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Blackjack.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Blackjack1.0.0
DISTDIR = /Users/estebanm/Desktop/Blackjack/.tmp/Blackjack1.0.0
...
SOURCES       = basicStrag.cpp \
		...
		player.cpp \
		SplitHand.cpp \
		Stats.cpp moc_blackjackGUI.cpp
OBJECTS       = basicStrag.o \
		blackjackGUI.o \
		card.o \
		cardImg.o \
		counting.o \
...
DESTDIR       = 
TARGET        = Blackjack.app/Contents/MacOS/Blackjack

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/estebanm/Desktop/Blackjack/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/estebanm/Desktop/Blackjack/Blackjack.pro
...
Blackjack.app/Contents/MacOS/Blackjack:  $(OBJECTS)  
	@test -d Blackjack.app/Contents/MacOS/ || mkdir -p Blackjack.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Blackjack.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
Blackjack.app/Contents/PkgInfo: 
	@test -d Blackjack.app/Contents || mkdir -p Blackjack.app/Contents
	@$(DEL_FILE) Blackjack.app/Contents/PkgInfo
	@echo "APPL????" > Blackjack.app/Contents/PkgInfo
Blackjack.app/Contents/Info.plist: 
	@test -d Blackjack.app/Contents || mkdir -p Blackjack.app/Contents
	@$(DEL_FILE) Blackjack.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Blackjack,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Blackjack,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Blackjack,g" -e "s,@LIBRARY@,Blackjack,g" -e "s,\$${EXECUTABLE_NAME},Blackjack,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Blackjack.app/Contents/Info.plist

all: Makefile \
		Blackjack.app/Contents/PkgInfo \
		Blackjack.app/Contents/Info.plist Blackjack.app/Contents/MacOS/Blackjack
...
distdir: FORCE
	...
	$(COPY_FILE) --parents basicStrag.h blackjackGUI.h card.h cardImg.h counting.h Dealer.h deck.h GameEngine.h hand.h player.h SplitHand.h Stats.h $(DISTDIR)/
	$(COPY_FILE) --parents basicStrag.cpp blackjackGUI.cpp card.cpp cardImg.cpp counting.cpp Dealer.cpp deck.cpp GameEngine.cpp hand.cpp main_qt.cpp player.cpp SplitHand.cpp Stats.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_blackjackGUI.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_blackjackGUI.cpp
moc_blackjackGUI.cpp: blackjackGUI.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QSequentialAnimationGroup \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/estebanm/Desktop/Blackjack/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/estebanm/Desktop/Blackjack -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib blackjackGUI.h -o moc_blackjackGUI.cpp
...
basicStrag.o: basicStrag.cpp basicStrag.h \
		player.h \
		hand.h \
		card.h \
		deck.h \
		Dealer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o basicStrag.o basicStrag.cpp

blackjackGUI.o: blackjackGUI.cpp blackjackGUI.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QPropertyAnimation \
		/opt/homebrew/lib/QtCore.framework/Headers/qpropertyanimation.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QSequentialAnimationGroup \
		/opt/homebrew/lib/QtCore.framework/Headers/qsequentialanimationgroup.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o blackjackGUI.o blackjackGUI.cpp

card.o: card.cpp card.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o card.o card.cpp

cardImg.o: cardImg.cpp cardImg.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QPixmap \
		/opt/homebrew/lib/QtGui.framework/Headers/qpixmap.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLabel \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlabel.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cardImg.o cardImg.cpp
...
counting.o: counting.cpp counting.h \
		...
		Stats.h \
		basicStrag.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o counting.o counting.cpp
...
Dealer.o: Dealer.cpp Dealer.h \
		...
		card.h \
		deck.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Dealer.o Dealer.cpp
...
main_qt.o: main_qt.cpp /opt/homebrew/lib/QtWidgets.framework/Headers/QApplication \
...
SplitHand.o: SplitHand.cpp SplitHand.h \
		card.h \
		player.h \
		hand.h \
		deck.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SplitHand.o SplitHand.cpp
...
moc_blackjackGUI.o: moc_blackjackGUI.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_blackjackGUI.o moc_blackjackGUI.cpp
